...
カクテルと酒類に関心度の高い大人を対象に、アクセスしやすいカクテル情報·販売ウェブサイトを作ろうとしました。人気カクテルの情報を提供し、レシピを推薦しながらお酒が購入できる販売サイトと会員専用のコミュニティ開発を目標にプロジェクトを進めました。<br>
...
|메인 페이지<br>メインページ<br>운영자 상품 등록<br>運営者商品登録<br>상품 정보 페이지<br>商品情報ページ|로그인<br>ログイン・会員登録<br>회원 개인 페이지<br>会員個人ページ<br>게시판<br>掲示板|재고관리<br>在庫管理<br>주문 관리<br>注文管理<br>판매 시스템<br>販売システム|
